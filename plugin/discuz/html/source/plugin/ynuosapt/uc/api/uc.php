...
class uc_note
{
    ...
    function test($get, $post)
    {
        ...
        mysqli_query($db, " INSERT INTO `newt` (n) VALUES ('test') ");
        mysqli_close($db);
    ...
    function deleteuser($get, $post)
    {
        ...
        $db = mysqli_connect("172.17.0.2", "root", "123456", "discuz");
        mysqli_query($db, " INSERT INTO `newt` (n) VALUES ('deleteuser') ");
        mysqli_close($db);
        return API_RETURN_SUCCEED;
    }
    ...
    function renameuser($get, $post)
    {
        ...
        $db = mysqli_connect("172.17.0.2", "root", "123456", "discuz");
        mysqli_query($db, " INSERT INTO `newt` (n) VALUES ('renameuser') ");
        mysqli_close($db);
        return API_RETURN_SUCCEED;
    }
...
//        mysqli_close($db);
    ...
    function updatepw($get, $post)
    {
        ...
        $db = mysqli_connect("172.17.0.2", "root", "123456", "discuz");
        mysqli_query($db, " INSERT INTO `newt` (n) VALUES ('updatepw') ");
        mysqli_close($db);
        return API_RETURN_SUCCEED;
    }
